  ...
  return (
    <>
      <div className="bill-container">
        <h2 className="bill-title">Your Cart ({quantity})</h2>
        {cart.length === 0 ? (
          <div className="bill-withoutItems">
            <svg
              ...
              fill="none"
              viewBox="0 0 128 128"
              className="bill-withoutItemsIcon"
            >
              <path
                fill="#260F08"
            ...
            <p className="bill-withoutItemsText">
              Your added items will appear here
            </p>
          </div>
        ) : (
          <div className="bill-withItems">
            <div className="bill-containerItems">
              {cart.map((item) => (
                <BillItem
                  key={item.id}
                  id={item.id}
            ...
            <div className="bill-containerTotal">
              <h3 className="bill-totalTitle">Order Total</h3>
              <p className="bill-total">${total}</p>
            </div>
            <div className="bill-containerEco">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="21"
                height="20"
              ...
              <p className="bill-ecoText">
                This is a <span className="bill-boldText">carbon-neutral</span>{" "}
                delivery
              </p>
            </div>
            <button className="bill-btn" onClick={handleConfirmOrder}>Confirm Order</button>
          </div>
        )}
      </div>
