...
import { newOrder } from "./cartSlice.jsx";

export function ConfirmedOrder({ isOpen, onClose }) {
    ...
    <div className="confirmed-order">
      <div className="confirmed-container">
        ...
        <div className="confirmed-text">
          <h2 className="confirmed-textTitle">Order Confirmed</h2>
          <p className="confirmed-textSubtitle">We hope you enjoy your food!</p>
        </div>

        <div className="confirmed-orderTotal">
          ...
          <div className="confirmed-total">
            <h3 className="confirmed-totalTitle">Order Total</h3>
            <p className="confirmed-totalPrice">${total}</p>
          </div>
        </div>
